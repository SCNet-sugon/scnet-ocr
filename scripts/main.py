...
def main():
    if len(sys.argv) != 3:
        ...
        print("ocrType 可选值: GENERAL, BILL_MIXING_AND_IDENTIFICATION, SEAL_CHARACTER_RECOGNITION, TABLE_RECOGNITION, ID_CARD, BANK_CARD, SOCIAL_SECURITY_CARD, HOUSEHOLD_REGISTER, BIRTH_CERTIFICATE, HK_MACAU_PASS, TAIWAN_PASS, TAIWAN_MAINLAND_PASS, HK_MAINLAND_PASS, HONG_KONG_IDENTITY_CARD, PERMANENT_RESIDENCE_ID_CARD_FOR, MARRIAGE_CERTIFICATE, REAL_ESTATE_OWNERSHIP_CERTIFICAT, FRONT_PAGE_OF_MOTOR_VEHICLE_DRIV, SECOND_SHEET_OF_MOTOR_VEHICLE_DR, MOTOR_VEHICLE_DRIVING_LICENSE, MOTOR_VEHICLE_DRIVING_LICENSE_SU, CHINESE_PASSPORT, ACADEMIC_CERTIFICATE, ONLINE_VERIFICATION_REPORT_OF_HE, DIPLOMA, BUSINESS_LICENSE, SOCIAL_ORG_REG, TRADE_UNION_REG, RELIGIOUS_ACTIVITY_REG, PRIVATE_NON_ENTERPRISE_REG, INSTITUTION_LEGAL_REG, UNIFIED_SOCIAL_CREDIT_REG, UNIFIED_IDENTIFICATION_OF_FINANC, FOOD_BUSINESS_LICENSE, FOOD_PRODUCTION_LICENSE, HYGIENE_LICENSE, FINANCIAL_LICENSE, FINANCIAL_INSTITUTION_CODE_CERT, PAYMENT_BUSINESS_LICENSE, ACCOUNT_OPENING_LICENSE, TRADEMARK_REGISTRATION_CERT, TAX_REGISTRATION_CERT, ORGANIZATION_CODE_CERT, VAT_TOLL_INVOICE, RIDE_HAILING_ITINERARY, UNIONPAY_POS_RECEIPT, MEDICAL_INPATIENT_INVOICE, MEDICAL_EXPENSE_SETTLEMENT, FISCAL_AUTH_PAYMENT_VOUCHER, CUSTOMS_PAYMENT_RECEIPT, CUSTOMS_DECLARATION, INTERNATIONAL_BILL, COMMERCIAL_INVOICE, CERTIFICATE_OF_ORIGIN, CARGO_TRANSPORT_INSURANCE, PACKING_LIST, BILL_OF_LADING, VAT_INVOICE, VAT_ROLL_INVOICE, TAXI_INVOICE, TRAIN_TICKET, AIRPORT_TICKET, VEHICLE_SALE_INVOICE, QUOTA_INVOICE, TOLL_INVOICE, MEDICAL_INVOICE, TAX_CERTIFICATE, SHIP_TICKET, NON_TAX_BILL, GENERAL_MACHINE_INVOICE, BUS_TICKET")
        sys.exit(1)
