...
def main():
    if len(sys.argv) != 3:
        ...
        print("ocrType 可选值: GENERAL, ID_CARD, BANK_CARD, SOCIAL_SECURITY_CARD, HOUSEHOLD_REGISTER, BIRTH_CERTIFICATE, HK_MACAU_PASS, TAIWAN_PASS, TAIWAN_MAINLAND_PASS, HK_MAINLAND_PASS, BUSINESS_LICENSE, SOCIAL_ORG_REG, TRADE_UNION_REG, RELIGIOUS_ACTIVITY_REG, PRIVATE_NON_ENTERPRISE_REG, INSTITUTION_LEGAL_REG, UNIFIED_SOCIAL_CREDIT_REG, VAT_INVOICE, VAT_ROLL_INVOICE, TAXI_INVOICE, TRAIN_TICKET, AIRPORT_TICKET, VEHICLE_SALE_INVOICE, QUOTA_INVOICE, TOLL_INVOICE, MEDICAL_INVOICE, TAX_CERTIFICATE, SHIP_TICKET, NON_TAX_BILL, GENERAL_MACHINE_INVOICE, BUS_TICKET")
        sys.exit(1)
